...
//         console.log(this.object_config)
//         this.size = {
...
class PysimBox extends WorldObject {
    constructor(scene, object_id, config) {
        ...
        this.size = {
            ...
            z: this.config['size']['z']
        }
        this.position = this.config['pos']
        this.orientation = this.config['ori']
        ...
        this.body.material = this.material
        this.body.material.alpha = this.config['alpha']
    ...
    setPosition(position) {
        ...
        this.position = position
        this.body.position = ToBabylon([position['x'], position['y'], position['z']+this.size.z/2])
    }
...
class TWIPR_Robot extends WorldObject {
    ...
    setPosition(position) {
        ...
        this.mesh.position = ToBabylon([position['x'], position['y'], this.config['physics']['wheel_diameter']/2+z_pos])
    }
